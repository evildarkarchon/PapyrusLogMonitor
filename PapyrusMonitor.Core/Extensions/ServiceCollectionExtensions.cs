...
public static class ServiceCollectionExtensions
{
    ...
    private static string GetDefaultLogPath()
    {
        ...
        var fallout4Path = Path.Combine(userProfile, "Documents", "My Games", "Fallout4", "Logs", "Script", "Papyrus.0.log");
        var skyrimPath = Path.Combine(userProfile, "Documents", "My Games", "Skyrim", "Logs", "Script", "Papyrus.0.log");
